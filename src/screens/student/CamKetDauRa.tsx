...
const CamKetDauRa = () => {
  return (
    <View style={containerStyles.screen}>
      <ScreenHeader title="Cam Kết" subtitle="Cam kết đầu ra" />
      <View style={styles.content}>
        <View style={[iconContainerStyles.large, iconContainerStyles.primary]}>
          <Icon name="certificate-outline" size={28} color={theme.colors.primary} />
        </View>
        <Text style={[textStyles.h4, styles.title]}>Cam kết đầu ra</Text>
