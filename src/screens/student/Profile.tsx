...
const detailItems = [
  { id: 'class', icon: 'school-outline', label: 'Lớp', value: 'IELTS Advanced 6.5+' },
  { id: 'center', icon: 'home-city', label: 'Trung tâm', value: 'WISE English - Quận 1' },
  { id: 'mentor', icon: 'account-tie', label: 'Giáo viên phụ trách', value: 'Ms. Selena' },
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          <View style={styles.profileHeader}>
            ...
            <View style={styles.profileInfo}>
              <Text style={styles.profileName}>WISE Student</Text>
              <Text style={styles.profileSub}>Mã HV: ST20241119</Text>
            </View>
          ...
          <View style={styles.badgeRow}>
            ...
            <View style={styles.badge}>
              <Text style={styles.badgeValue}>128</Text>
              <Text style={styles.badgeLabel}>Giờ học</Text>
            </View>
            <View style={styles.badge}>
              <Text style={styles.badgeValue}>A</Text>
              <Text style={styles.badgeLabel}>Xếp loại</Text>
            </View>
          </View>
        </View>
        ...
        {/* Center Details Card */}
        <View style={styles.card}>
          <Text style={styles.sectionTitle}>Chi tiết trung tâm</Text>
